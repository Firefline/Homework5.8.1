// Homework5.8.1.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
public:
    ...
    auto clone()
    {
        return std::move(std::make_unique<tridiagonal_matrix> (m_down, m_upper, m_middle));
    }
};
...
int main(int argc, char** argv)
{
    ...
    //auto matrix_clone = std::move(matrix);
